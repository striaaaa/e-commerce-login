...
<html lang="en">
  ...
  <body>
    ...
    <section class="product-container">
      <!-- left side -->
      <div class="img-card">
        <img src="img/detail/e-3.png" alt="" id="featured-image" />
        <!-- small img -->
        <div class="small-Card">
          <img src="img/detail/e-3.png" alt="" class="small-Img" />
          <img src="img/detail/e-1.png" alt="" class="small-Img" />
          <img src="img/detail/e-2.png" alt="" class="small-Img" />
          <img src="img/detail/e-4.png" alt="" class="small-Img" />
        </div>
      </div>
      <!-- Right side -->
      <div class="product-info">
        <h3>Adidas Trefoil Essentials Hoodie</h3>
        <h5>Price: $129<del>$189</del></h5>
        <p>
