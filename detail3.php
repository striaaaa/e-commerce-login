...
<html lang="en">
  ...
  <body>
    ...
    <div class="pagination">
      <a href="home.php"><p>Home ></a><a href="Shops.php">Shop</a></p>
    </div>
    <!-- product section -->
    <section class="product-container">
      <!-- left side -->
      <div class="img-card">
        <img src="img/detail/b-1.jpeg" alt="" id="featured-image" />
        <!-- small img -->
        <div class="small-Card">
          <img src="img/detail/b-1.jpeg" alt="" class="small-Img" />
          <img src="img/detail/b-2.jpeg" alt="" class="small-Img" />
          <img src="img/detail/b-3.jpeg" alt="" class="small-Img" />
          <img src="img/detail/b-4.jpeg" alt="" class="small-Img" />
        </div>
      </div>
      <!-- Right side -->
      <div class="product-info">
        <h3>The North Face Women MFO Travel Fleece Tri Jacket</h3>
        <h5>Price: $349 <del>$499</del></h5>
        <p>
