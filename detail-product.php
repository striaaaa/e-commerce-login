...
<html lang="en">
  ...
  <body>
    ...
    <nav class="section__container nav__container">
      <a href="Shops.html" class="nav__logo"
        ><img
    ...
    <section class="product-container">
      <!-- left side -->
      <div class="img-card">
        <img src="img/detail/1.jpeg" alt="" id="featured-image" />
        <!-- small img -->
        <div class="small-Card">
          <img src="img/detail/1.jpeg" alt="" class="small-Img" />
          <img src="img/detail/2.jpeg" alt="" class="small-Img" />
          <img src="img/detail/3.jpeg" alt="" class="small-Img" />
          <img src="img/detail/4.jpeg" alt="" class="small-Img" />
        </div>
      </div>
      <!-- Right side -->
      <div class="product-info">
        <h3>Reebok Men Performance Polo</h3>
        <h5>Price: $67.24 <del>$170</del></h5>
        <p>
