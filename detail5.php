...
<html lang="en">
  ...
  <body>
    ...
    <section class="product-container">
      <!-- left side -->
      <div class="img-card">
        <img src="img/detail/c-1-hd.png" alt="" id="featured-image" />
        <!-- small img -->
        <div class="small-Card">
          <img src="img/detail/c-1-hd.png" alt="" class="small-Img" />
          <img src="img/detail/c-2 hd.png" alt="" class="small-Img" />
          <img src="img/detail/c-3 hd.png" alt="" class="small-Img" />
          <img src="img/detail/c-4.png" alt="" class="small-Img" />
        </div>
      </div>
      <!-- Right side -->
      <div class="product-info">
        <h3>Adidas Indigo Herz Fur Hoodie</h3>
        <h5>Price: $90.00 <del>$199,00</del></h5>
        <p>
