...
<html lang="en">
  ...
  <body>
    ...
    <section class="product-container">
      <!-- left side -->
      <div class="img-card">
        <img src="img/detail/a-1.jpeg" alt="" id="featured-image" />
        <!-- small img -->
        <div class="small-Card">
          <img src="img/detail/a-1.jpeg" alt="" class="small-Img" />
          <img src="img/detail/a-2.jpeg" alt="" class="small-Img" />
          <img src="img/detail/a-3.jpeg" alt="" class="small-Img" />
          <img src="img/detail/a-4.jpeg" alt="" class="small-Img" />
        </div>
      </div>
      <!-- Right side -->
      <div class="product-info">
        <h3>Adidas Track Jacket Adicolor Classics Firebird</h3>
        <h5>Price: $169 <del>$270</del></h5>
        <p>
